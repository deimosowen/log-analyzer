...
public interface IMetadataRepository
{
    ...
    Task<string?> CreateShareInviteAsync(string creatorUserId, string projectId, CancellationToken cancellationToken);
    Task<ProjectShareInvitePreview?> GetShareInvitePreviewAsync(string token, CancellationToken cancellationToken);
    Task<ShareInviteAcceptResult> AcceptShareInviteAsync(string userId, string token, CancellationToken cancellationToken);
